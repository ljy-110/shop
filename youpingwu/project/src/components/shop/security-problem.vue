                ...
                <div class="main">
                    <el-card class="box-card">
                        <div slot="header" class="clearfix">
                            <span>设置安全问题 / Set Safety Question</span>
                        </div>
                        <div class="text item">
                            ...
                            <div class="step-bb center">
                                    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm step-bb-pp">
                                        <el-form-item label="问题一">
                                            <span>你最喜欢的颜色是什么？</span>
                                        </el-form-item>
                                        <el-form-item label="答案" prop="daan1" required>
                                            <el-input v-model="ruleForm.daan1" placeholder="请输入你的答案"></el-input>
                                        </el-form-item>
                                        <el-form-item label="问题一">
                                            <span>你的故乡在哪里？</span>
                                        </el-form-item>
                                        <el-form-item label="答案" prop="daan2" required>
                                            <el-input v-model="ruleForm.daan2" placeholder="请输入你的答案"></el-input>
                                        </el-form-item>
                                        <el-form-item label="问题一">
                                            <span>你最喜欢的人是谁？</span>
                                        </el-form-item>
                                        <el-form-item label="答案" prop="daan3" required>
                                            <el-input v-model="ruleForm.daan3" placeholder="请输入你的答案"></el-input>
                                        </el-form-item>
